...
function Popup(props) { 
  ...
  const [printerData, setPrinterData] = useState({
    ...
    description: "none",
    campus: "CS1 - Lý Thường Kiệt", // Giá trị mặc định là cơ sở 1
    location: "H6",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await printerAPI.updatePrinter( 
      ...
      toast.error("Lỗi khi cập nhật máy in");
    }
  };
  ...
  return props.trigger ? (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50 bg-gray-800 bg-opacity-50">
      <div className="form-container max-w-lg mx-auto px-20 py-8 bg-[#6da3d5] rounded-lg shadow-md">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Thao tác máy in</h2>
