  ...
  return (
    <nav class="bg-[#132d65]">
      ...
      <a onClick={() => handleNavigation("/")} href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span class="self-center text-2xl font-semibold whitespace-nowrap text-white px-2">HCMUT</span>
      </a>
      <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
          <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border rounded-lg bg-[#132d65] text-white md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  ">
            <li>
              <a href="/" class="block py-2 px-3 md:p-0" aria-current="page">Trang chủ</a>
            </li>
            <li>
              <a href="/infor" onClick={() => handleNavigation("/infor")} class="block py-2 px-3 md:p-0">Thông tin cá nhân</a>
            </li>
            <li>
              <a href="/print" onClick={() => handleNavigation("/print")} class="block py-2 px-3 md:p-0">In tài liệu</a>
            </li>
            <li>
              <a href="/buy" onClick={() => handleNavigation("/buy")} class="block py-2 px-3 md:p-0">Mua trang in</a>
            </li>
            <li>
              <a href="/log" onClick={() => handleNavigation("/log")} class="block py-2 px-3 md:p-0">Lịch sử</a>
            </li>
          </ul>
        </div> 
      </div>
